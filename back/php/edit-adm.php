...
<nav class="sidebar" id="sidebar">
      <div class="sidebar-content">
        <div class="user">
          ...
          <h1 class="name"><span class="item-name" id="title"><strong>Arthropoda</strong></span></h1>
        </div>
        <ul class="side-items">
...
<main>
  ...
  <section class="perfil-editar" aria-label="Formulário para editar perfil">
    ...
    <form action="acoes.php" method="POST" enctype="multipart/form-data">
      ...
      <div class="botoes">
       ...
       <button type="submit" name="update-comum"class="botao">Salvar</button>
      </form>
  </section>
  ...
  <section class="configuracoes-section" aria-label="Configurações do sistema">
    ...
    <div id="gerais" class="settings-content active">
      ...
      <button class="botao" onclick="window.SettingsManager.saveSettings()">Salvar Configurações</button>
    </div>
